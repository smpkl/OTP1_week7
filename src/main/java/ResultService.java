...
public class ResultService {
    ...
    private static String getDatabaseHost() {
        ...
        if (host == null || host.isEmpty()) host = "calculator-db"; // use Docker service name
        return host;
    }
    ...
    public static void saveResult(double n1, double n2, double sum, double subtraction, double product, double division) {
        ...
        try (Connection conn = DriverManager.getConnection(dbUrl, DB_USER, DB_PASSWORD);
            ...
            // Insert the result
            String insert = "INSERT INTO calc_results (number1, number2, sum_result, subtraction_result, product_result, division_result) VALUES (?, ?, ?, ?, ?, ?)";
            ...
            System.out.println("✅ Result saved: " + n1 + ", " + n2 + " → Sum=" + sum + ", Sub=" + subtraction + ", Product=" + product + ", Division=" + division);
